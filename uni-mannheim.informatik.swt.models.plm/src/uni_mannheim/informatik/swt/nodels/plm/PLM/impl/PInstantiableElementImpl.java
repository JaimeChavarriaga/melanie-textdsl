 ...
 * <ul>
 *   <li>{@link uni_mannheim.informatik.swt.nodels.plm.PLM.impl.PInstantiableElementImpl#getPotency <em>Potency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PInstantiableElementImpl extends PLevelSpecificElementImpl implements PInstantiableElement {
	...
	protected EClass eStaticClass() {
		return PLMPackage.Literals.PINSTANTIABLE_ELEMENT;
	}
	...
	public void setPotency(int newPotency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.PINSTANTIABLE_ELEMENT__POTENCY, oldPotency, potency));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PLMPackage.PINSTANTIABLE_ELEMENT__POTENCY:
				return getPotency();
		}
