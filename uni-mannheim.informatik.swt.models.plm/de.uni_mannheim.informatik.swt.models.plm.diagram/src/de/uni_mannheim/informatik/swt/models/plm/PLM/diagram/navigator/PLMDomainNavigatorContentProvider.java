...
public class PLMDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.navigator.PLMDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.navigator.PLMDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.navigator.PLMDomainNavigatorItem(
