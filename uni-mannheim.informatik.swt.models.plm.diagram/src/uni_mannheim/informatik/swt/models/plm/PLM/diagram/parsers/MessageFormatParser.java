...
public class MessageFormatParser
		extends
		uni_mannheim.informatik.swt.models.plm.PLM.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							uni_mannheim.informatik.swt.models.plm.PLM.diagram.part.Messages.MessageFormatParser_InvalidInputError,
