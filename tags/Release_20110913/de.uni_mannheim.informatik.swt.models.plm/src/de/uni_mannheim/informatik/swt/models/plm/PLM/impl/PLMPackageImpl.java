...
public class PLMPackageImpl extends EPackageImpl implements PLMPackage {
	 ...
	 * @generated
	 */
	public EOperation getModel__GetAllInstantiations() {
	 ...
	 * @generated
	 */
	public EReference getClabject_Blueprint() {
	...
	public EReference getClabject_Feature() {
		return (EReference)clabjectEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EOperation getClabject__GetModelBlueprint() {
	...
	public void createPackageContents() {
		...
		createEOperation(modelEClass, MODEL___GET_ALL_INSTANTIATIONS);
		...
		createEReference(clabjectEClass, CLABJECT__BLUEPRINT);
		...
		createEOperation(clabjectEClass, CLABJECT___GET_MODEL_BLUEPRINT);
	...
	public void initializePackageContents() {
		...
		initEOperation(getModel__GetAllInstantiations(), this.getInstantiation(), "getAllInstantiations", 0, -1, IS_UNIQUE, !IS_ORDERED);
		...
		initEReference(getInstantiation_Instance(), this.getClabject(), null, "instance", null, 1, 1, Instantiation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInstantiation_Type(), this.getClabject(), null, "type", null, 1, 1, Instantiation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstantiation_Kind(), this.getClassificationKind(), "kind", "instantiation", 1, 1, Instantiation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getClabject_Blueprint(), this.getClabject(), null, "blueprint", null, 0, 1, Clabject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getClabject__GetModelClassificationsAsInstance(), this.getInstantiation(), "getModelClassificationsAsInstance", 0, -1, IS_UNIQUE, !IS_ORDERED);

		initEOperation(getClabject__GetModelClassificationsAsType(), this.getInstantiation(), "getModelClassificationsAsType", 0, -1, IS_UNIQUE, !IS_ORDERED);
		...
		initEOperation(getClabject__GetModelBlueprint(), this.getClabject(), "getModelBlueprint", 0, 1, IS_UNIQUE, !IS_ORDERED);
	...
	protected void createCommentAnnotations() {
		...
		addAnnotation
		  (instantiationEClass, 
		   source, 
		   new String[] {
			 "derived targetLevel", "return (this.getType() != null) ? this.getType().getLevel() : -1;"
		   });		
		addAnnotation
		  (clabjectEClass, 
		   source, 
	...
	protected void createOCLAnnotations() {
		...
		addAnnotation
		  (getModel__GetAllInstantiations(), 
		   source, 
		   new String[] {
			 "body", "self.content->select(e|e.oclIsKindOf(Instantiation))->collect(g | g.oclAsType(Instantiation))->asSet()"
		   });		
		addAnnotation
		...
		addAnnotation
		  (getClabject__AllInstancesFrom__String(), 
		   source, 
		   new String[] {
			 "body", "Instantiation.allInstances()->select(i | i.type = self).instance"
		   });		
		addAnnotation
		...
		addAnnotation
		  (getClabject__GetModelClassificationsAsInstance(), 
		   source, 
		   new String[] {
			 "body", "Instantiation.allInstances()->select(i|i.instance = self)"
		   });		
		addAnnotation
		  (getClabject__GetModelClassificationsAsType(), 
		   source, 
		   new String[] {
			 "body", "Instantiation.allInstances()->select(i|i.type = self)"
		   });		
		addAnnotation
		...
		addAnnotation
		  (getClabject__GetModelBlueprint(), 
		   source, 
		   new String[] {
			 "body", "OclInvalid"
		   });		
		...
		addAnnotation
		  (getConnection__GetRoleNameForParticipant__Clabject(), 
		   source, 
		   new String[] {
			 "body", "self.roleName->at(self.participant->indexOf(participant))"
		   });		
		addAnnotation
