...
public class EbnfmmAdapterFactory extends AdapterFactoryImpl {
	...
	protected EbnfmmSwitch<Adapter> modelSwitch =
		new EbnfmmSwitch<Adapter>() {
			...
			public Adapter caseFactorableSymbol(FactorableSymbol object) {
				return createFactorableSymbolAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uni_mannheim.informatik.swt.models.ebnf.ebnfmm.FactorableSymbol <em>Factorable Symbol</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFactorableSymbolAdapter() {
		return null;
	}
