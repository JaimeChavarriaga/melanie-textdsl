...
public class DomainEntityEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainEntityNameLevelEditPart) {
			((de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainEntityNameLevelEditPart) childEditPart)
	...
	public class DomainEntityFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			this.add(fFigureDomainEntityNameFigure);
