 ...
 *   <li>{@link de.uni_mannheim.informatik.swt.models.plm.PLM.impl.ClabjectImpl#getBlueprint <em>Blueprint</em>}</li>
...
public class ClabjectImpl extends DomainElementImpl implements Clabject {
	...
	public Clabject getBlueprint() {
		if (blueprint != null && blueprint.eIsProxy()) {
			InternalEObject oldBlueprint = (InternalEObject)blueprint;
			blueprint = (Clabject)eResolveProxy(oldBlueprint);
			if (blueprint != oldBlueprint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PLMPackage.CLABJECT__BLUEPRINT, oldBlueprint, blueprint));
			}
		}
		return blueprint;
	}
	 ...
	 * @generated
	 */
	public Clabject basicGetBlueprint() {
		return blueprint;
	}
	 ...
	 * @generated
	 */
	public void setBlueprint(Clabject newBlueprint) {
		Clabject oldBlueprint = blueprint;
		blueprint = newBlueprint;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.CLABJECT__BLUEPRINT, oldBlueprint, blueprint));
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public EList<Instantiation> getModelClassificationsAsInstance() {
		try {
			return (EList<Instantiation>)GET_MODEL_CLASSIFICATIONS_AS_INSTANCE__EINVOCATION_DELEGATE.dynamicInvoke(this, null);
		}
		catch (InvocationTargetException ite) {
			throw new WrappedException(ite);
		}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public EList<Instantiation> getModelClassificationsAsType() {
		try {
			return (EList<Instantiation>)GET_MODEL_CLASSIFICATIONS_AS_TYPE__EINVOCATION_DELEGATE.dynamicInvoke(this, null);
		}
		catch (InvocationTargetException ite) {
			throw new WrappedException(ite);
		}
	...
	/**
	 * The cached invocation delegate for the '{@link #getModelBlueprint() <em>Get Model Blueprint</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getModelBlueprint()
	 * @generated
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_MODEL_BLUEPRINT__EINVOCATION_DELEGATE = ((EOperation.Internal)PLMPackage.Literals.CLABJECT___GET_MODEL_BLUEPRINT).getInvocationDelegate();
	 ...
	 * @generated
	 */
	public Clabject getModelBlueprint() {
		try {
			return (Clabject)GET_MODEL_BLUEPRINT__EINVOCATION_DELEGATE.dynamicInvoke(this, null);
		}
		catch (InvocationTargetException ite) {
			throw new WrappedException(ite);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PLMPackage.CLABJECT__LEVEL:
				return getLevel();
			case PLMPackage.CLABJECT__BLUEPRINT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PLMPackage.CLABJECT__LEVEL:
				...
				return;
			case PLMPackage.CLABJECT__BLUEPRINT:
				setBlueprint((Clabject)newValue);
				return;
			case PLMPackage.CLABJECT__CONTENT:
				getContent().clear();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case PLMPackage.CLABJECT___GET_MODEL_BLUEPRINT:
				return getModelBlueprint();
