...
/**
 * This is the item provider adapter for a {@link ebnfmm.Symbol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SymbolItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Symbol_factor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Symbol_factor_feature", "_UI_Symbol_type"),
				 EbnfmmPackage.Literals.SYMBOL__FACTOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Symbol_type") + " " + symbol.getFactor();
	}
