 ...
 * <ul>
 *   <li>{@link uni_mannheim.informatik.swt.models.plm.PanLevelModel.impl.PanLevelModelImpl#getModelElements <em>Model Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PanLevelModelImpl extends EObjectImpl implements PanLevelModel {
	...
	protected EClass eStaticClass() {
		return PanLevelModelPackage.Literals.PAN_LEVEL_MODEL;
	}
	...
	public EList<PElement> getModelElements() {
		if (modelElements == null) {
			modelElements = new EObjectContainmentEList<PElement>(PElement.class, this, PanLevelModelPackage.PAN_LEVEL_MODEL__MODEL_ELEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PanLevelModelPackage.PAN_LEVEL_MODEL__MODEL_ELEMENTS:
