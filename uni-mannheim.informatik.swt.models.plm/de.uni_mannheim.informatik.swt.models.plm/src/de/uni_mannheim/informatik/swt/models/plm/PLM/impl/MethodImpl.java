...
public class MethodImpl extends FeatureImpl implements Method {
	 ...
	 * @ordered
	 */
	protected EList<PotentElement> input;
	 ...
	 * @ordered
	 */
	protected EList<PotentElement> output;
	 ...
	 * @generated
	 */
	public EList<PotentElement> getInput() {
		if (input == null) {
			input = new EObjectResolvingEList<PotentElement>(PotentElement.class, this, PLMPackage.METHOD__INPUT);
		}
		return input;
	}
	 ...
	 * @generated
	 */
	public EList<PotentElement> getOutput() {
		if (output == null) {
			output = new EObjectResolvingEList<PotentElement>(PotentElement.class, this, PLMPackage.METHOD__OUTPUT);
		}
		return output;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PLMPackage.METHOD__INPUT:
				getInput().clear();
				getInput().addAll((Collection<? extends PotentElement>)newValue);
				return;
			case PLMPackage.METHOD__OUTPUT:
				getOutput().clear();
				getOutput().addAll((Collection<? extends PotentElement>)newValue);
				return;
		}
