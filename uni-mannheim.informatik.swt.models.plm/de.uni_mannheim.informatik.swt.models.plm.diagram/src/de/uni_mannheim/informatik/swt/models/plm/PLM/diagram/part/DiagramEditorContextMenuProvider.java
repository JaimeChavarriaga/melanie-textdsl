...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
