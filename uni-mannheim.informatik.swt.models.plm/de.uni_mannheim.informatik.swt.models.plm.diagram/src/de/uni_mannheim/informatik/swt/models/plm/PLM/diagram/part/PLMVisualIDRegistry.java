...
public class PLMVisualIDRegistry {
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (de.uni_mannheim.informatik.swt.models.plm.PLM.PLMPackage.eINSTANCE
				...
				&& isDiagram((de.uni_mannheim.informatik.swt.models.plm.PLM.Model) domainElement)) {
			return de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.ModelEditPart.VISUAL_ID;
		}
		return -1;
	}
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.OntologyEditPart.VISUAL_ID:
			if (de.uni_mannheim.informatik.swt.models.plm.PLM.PLMPackage.eINSTANCE
					.getOntologyLevel().isSuperTypeOf(domainElement.eClass())) {
				return de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.OntologyLevelEditPart.VISUAL_ID;
			}
			break;
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.OntologyEditPart.VISUAL_ID:
			...
			if (de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.OntologyLevelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.OntologyLevelEditPart.VISUAL_ID:
			if (de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.OntologyLevelNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.OntologyLevelDomainElementsComartmentEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainEntityEditPart.VISUAL_ID:
			if (de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainEntityNameLevelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainConnectionEditPart.VISUAL_ID:
			if (de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainConnectionNameLevelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		}
	...
	private static boolean isDiagram(
			de.uni_mannheim.informatik.swt.models.plm.PLM.Model element) {
		return true;
	}
