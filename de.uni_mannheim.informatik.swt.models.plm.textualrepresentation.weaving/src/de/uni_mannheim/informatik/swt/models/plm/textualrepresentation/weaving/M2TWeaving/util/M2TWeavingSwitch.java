 ...
 * @generated
 */
public class M2TWeavingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case M2TWeavingPackage.WEAVING_MODEL: {
				WeavingModel weavingModel = (WeavingModel)theEObject;
				T result = caseWeavingModel(weavingModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case M2TWeavingPackage.WEAVING_MODEL_CONTENT: {
				WeavingModelContent weavingModelContent = (WeavingModelContent)theEObject;
				T result = caseWeavingModelContent(weavingModelContent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case M2TWeavingPackage.WEAVING_LINK: {
				WeavingLink weavingLink = (WeavingLink)theEObject;
				T result = caseWeavingLink(weavingLink);
				if (result == null) result = caseWeavingModelContent(weavingLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case M2TWeavingPackage.TEXT_ELEMENT: {
				TextElement textElement = (TextElement)theEObject;
				T result = caseTextElement(textElement);
				if (result == null) result = caseWeavingModelContent(textElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Weaving Model Content</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Weaving Model Content</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWeavingModelContent(WeavingModelContent object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Weaving Link</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Weaving Link</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWeavingLink(WeavingLink object) {
		return null;
	}
