 ...
 * <ul>
 *   <li>{@link uni_mannheim.informatik.swt.nodels.plm.PLM.impl.PInstantiationImpl#getTargetLevel <em>Target Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PInstantiationImpl extends PConnectorImpl implements PInstantiation {
	...
	protected EClass eStaticClass() {
		return PLMPackage.Literals.PINSTANTIATION;
	}
	...
	public void setTargetLevel(int newTargetLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.PINSTANTIATION__TARGET_LEVEL, oldTargetLevel, targetLevel));
	}
