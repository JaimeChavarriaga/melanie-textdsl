...
package de.uni_mannheim.informatik.swt.mlm.workbench.prespective;
...
public class MelaniePerspectiveFactory implements IPerspectiveFactory {
	...
	private void defineLayout(IPageLayout layout)
	{
        ...
        try {
        	IGraphicalVisualizationService graphicalVisualizationService = ExtensionPointService.Instance().getActiveVisualizationService();
        	if (graphicalVisualizationService != null){
        		IFolderLayout bottomRight = 
        	        	layout.createFolder("bottomRight", IPageLayout.RIGHT, 0.5f, "bottom");
    	        bottomRight.addView(graphicalVisualizationService.getGraphicalVisualizationEditorViewID());
        	}
		} catch (CoreException e) {
			e.printStackTrace();
		}
