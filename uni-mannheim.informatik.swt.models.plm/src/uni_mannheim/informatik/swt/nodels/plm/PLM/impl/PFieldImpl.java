...
import uni_mannheim.informatik.swt.nodels.plm.PLM.PField;
 ...
 * <ul>
 *   <li>{@link uni_mannheim.informatik.swt.nodels.plm.PLM.impl.PFieldImpl#isDual <em>Dual</em>}</li>
 *   <li>{@link uni_mannheim.informatik.swt.nodels.plm.PLM.impl.PFieldImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link uni_mannheim.informatik.swt.nodels.plm.PLM.impl.PFieldImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link uni_mannheim.informatik.swt.nodels.plm.PLM.impl.PFieldImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uni_mannheim.informatik.swt.nodels.plm.PLM.impl.PFieldImpl#getMultiplicityLower <em>Multiplicity Lower</em>}</li>
 *   <li>{@link uni_mannheim.informatik.swt.nodels.plm.PLM.impl.PFieldImpl#getMultiplicityUpper <em>Multiplicity Upper</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PFieldImpl extends PInstantiableElementImpl implements PField {
	...
	protected EClass eStaticClass() {
		return PLMPackage.Literals.PFIELD;
	}
	...
	public void setDual(boolean newDual) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.PFIELD__DUAL, oldDual, dual));
	}
	...
	public void setUnique(boolean newUnique) {
		...
		unique = newUnique;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.PFIELD__UNIQUE, oldUnique, unique));
	}
	...
	public void setDataType(Class<?> newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.PFIELD__DATA_TYPE, oldDataType, dataType));
	}
	...
	public EObject getValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PLMPackage.PFIELD__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(EObject newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.PFIELD__VALUE, oldValue, value));
	}
	...
	public void setMultiplicityLower(int newMultiplicityLower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.PFIELD__MULTIPLICITY_LOWER, oldMultiplicityLower, multiplicityLower));
	}
	...
	public void setMultiplicityUpper(int newMultiplicityUpper) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.PFIELD__MULTIPLICITY_UPPER, oldMultiplicityUpper, multiplicityUpper));
	}
