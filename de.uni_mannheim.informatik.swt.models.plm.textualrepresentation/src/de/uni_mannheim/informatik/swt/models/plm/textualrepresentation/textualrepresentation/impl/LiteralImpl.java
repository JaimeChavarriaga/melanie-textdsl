...
public class LiteralImpl extends TextualVisualizationDescriptorImpl implements Literal {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetColor(AbstractColor newColor, NotificationChain msgs) {
		AbstractColor oldColor = color;
		color = newColor;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TextualrepresentationPackage.LITERAL__COLOR, oldColor, newColor);
	 ...
	 * @generated
	 */
	public void setColor(AbstractColor newColor) {
		if (newColor != color) {
			NotificationChain msgs = null;
			if (color != null)
				msgs = ((InternalEObject)color).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TextualrepresentationPackage.LITERAL__COLOR, null, msgs);
			if (newColor != null)
				msgs = ((InternalEObject)newColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TextualrepresentationPackage.LITERAL__COLOR, null, msgs);
			msgs = basicSetColor(newColor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextualrepresentationPackage.LITERAL__COLOR, newColor, newColor));
	}
