...
public interface VisualizationPackage extends EPackage {
	...
	/**
	 * The operation id for the '<em>Get Link Decoration For Role Name</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int LINK___GET_LINK_DECORATION_FOR_ROLE_NAME__STRING = SHAPE_DESCRIPTOR_OPERATION_COUNT + 0;

	/**
	 * The operation id for the '<em>Get Label Descriptor For Role Name</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int LINK___GET_LABEL_DESCRIPTOR_FOR_ROLE_NAME__STRING = SHAPE_DESCRIPTOR_OPERATION_COUNT + 1;
	 ...
	 * @ordered
	 */
	int LINK_OPERATION_COUNT = SHAPE_DESCRIPTOR_OPERATION_COUNT + 2;
	 ...
	 * @ordered
	 */
	int LABEL_DESCRIPTOR__TARGET_ROLE_NAME = INFORMATION_DISPLAY_DESCRIPTOR_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int LABEL_DESCRIPTOR_FEATURE_COUNT = INFORMATION_DISPLAY_DESCRIPTOR_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int MAPPING_LABEL__TARGET_ROLE_NAME = LABEL_DESCRIPTOR__TARGET_ROLE_NAME;
	 ...
	 * @ordered
	 */
	int EXPRESSION_LABEL__TARGET_ROLE_NAME = LABEL_DESCRIPTOR__TARGET_ROLE_NAME;
	 ...
	 * @ordered
	 */
	int LINK_DECORATION__TARGET_ROLE_NAME = 5;
	 ...
	 * @ordered
	 */
	int LINK_DECORATION_FEATURE_COUNT = 6;
	 ...
	 * @ordered
	 */
	int DEFAULT_LINK_DECORATION__TARGET_ROLE_NAME = LINK_DECORATION__TARGET_ROLE_NAME;
	 ...
	 * @ordered
	 */
	int CUSTOM_LINK_DECORATION__TARGET_ROLE_NAME = LINK_DECORATION__TARGET_ROLE_NAME;
	...
	/**
	 * Returns the meta object for the '{@link de.uni_mannheim.informatik.swt.models.plm.visualization.Link#getLinkDecorationForRoleName(java.lang.String) <em>Get Link Decoration For Role Name</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Link Decoration For Role Name</em>' operation.
	 * @see de.uni_mannheim.informatik.swt.models.plm.visualization.Link#getLinkDecorationForRoleName(java.lang.String)
	 * @generated
	 */
	EOperation getLink__GetLinkDecorationForRoleName__String();

	/**
	 * Returns the meta object for the '{@link de.uni_mannheim.informatik.swt.models.plm.visualization.Link#getLabelDescriptorForRoleName(java.lang.String) <em>Get Label Descriptor For Role Name</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Label Descriptor For Role Name</em>' operation.
	 * @see de.uni_mannheim.informatik.swt.models.plm.visualization.Link#getLabelDescriptorForRoleName(java.lang.String)
	 * @generated
	 */
	EOperation getLink__GetLabelDescriptorForRoleName__String();
	...
	/**
	 * Returns the meta object for the attribute '{@link de.uni_mannheim.informatik.swt.models.plm.visualization.LabelDescriptor#getTargetRoleName <em>Target Role Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Target Role Name</em>'.
	 * @see de.uni_mannheim.informatik.swt.models.plm.visualization.LabelDescriptor#getTargetRoleName()
	 * @see #getLabelDescriptor()
	 * @generated
	 */
	EAttribute getLabelDescriptor_TargetRoleName();
	...
	/**
	 * Returns the meta object for the attribute '{@link de.uni_mannheim.informatik.swt.models.plm.visualization.LinkDecoration#getTargetRoleName <em>Target Role Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Target Role Name</em>'.
	 * @see de.uni_mannheim.informatik.swt.models.plm.visualization.LinkDecoration#getTargetRoleName()
	 * @see #getLinkDecoration()
	 * @generated
	 */
	EAttribute getLinkDecoration_TargetRoleName();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Get Link Decoration For Role Name</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation LINK___GET_LINK_DECORATION_FOR_ROLE_NAME__STRING = eINSTANCE.getLink__GetLinkDecorationForRoleName__String();

		/**
		 * The meta object literal for the '<em><b>Get Label Descriptor For Role Name</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation LINK___GET_LABEL_DESCRIPTOR_FOR_ROLE_NAME__STRING = eINSTANCE.getLink__GetLabelDescriptorForRoleName__String();
		 ...
		 * @generated
		 */
		EAttribute LABEL_DESCRIPTOR__TARGET_ROLE_NAME = eINSTANCE.getLabelDescriptor_TargetRoleName();
		 ...
		 * @generated
		 */
		EAttribute LINK_DECORATION__TARGET_ROLE_NAME = eINSTANCE.getLinkDecoration_TargetRoleName();
