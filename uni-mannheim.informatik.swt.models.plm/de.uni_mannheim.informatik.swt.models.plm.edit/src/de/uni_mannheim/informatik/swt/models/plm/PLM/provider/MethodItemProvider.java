...
/**
 * This is the item provider adapter for a {@link de.uni_mannheim.informatik.swt.models.plm.PLM.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addInputPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_input_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_input_feature", "_UI_Method_type"),
				 PLMPackage.Literals.METHOD__INPUT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutputPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_output_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_output_feature", "_UI_Method_type"),
				 PLMPackage.Literals.METHOD__OUTPUT,
				 true,
				 false,
				 true,
				 null,
