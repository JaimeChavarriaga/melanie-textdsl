...
public interface Model extends Element, TopLevelVisualizationContainer {
	 ...
	 * <!-- end-user-doc -->
	 * @model kind="operation" ordered="false"
	 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL body='self.content->select(e|e.oclIsKindOf(Instantiation))->collect(g | g.oclAsType(Instantiation))->asSet()'"
	 * @generated
	 */
	EList<Instantiation> getAllInstantiations();
