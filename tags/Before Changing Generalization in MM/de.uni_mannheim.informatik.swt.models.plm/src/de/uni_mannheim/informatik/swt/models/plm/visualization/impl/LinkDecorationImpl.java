 ...
 *   <li>{@link de.uni_mannheim.informatik.swt.models.plm.visualization.impl.LinkDecorationImpl#getTargetRoleName <em>Target Role Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LinkDecorationImpl extends EObjectImpl implements LinkDecoration {
	...
	public void setTargetRoleName(String newTargetRoleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualizationPackage.LINK_DECORATION__TARGET_ROLE_NAME, oldTargetRoleName, targetRoleName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case VisualizationPackage.LINK_DECORATION__TARGET_ROLE_NAME:
