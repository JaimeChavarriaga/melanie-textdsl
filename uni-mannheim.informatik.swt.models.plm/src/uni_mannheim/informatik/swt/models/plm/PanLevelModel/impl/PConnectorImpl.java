 ...
 * <ul>
 *   <li>{@link uni_mannheim.informatik.swt.models.plm.PanLevelModel.impl.PConnectorImpl#getParticipants <em>Participants</em>}</li>
 *   <li>{@link uni_mannheim.informatik.swt.models.plm.PanLevelModel.impl.PConnectorImpl#getRoleNames <em>Role Names</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PConnectorImpl extends PLevelSpecificElementImpl implements PConnector {
	...
	protected EClass eStaticClass() {
		return PanLevelModelPackage.Literals.PCONNECTOR;
	}
	...
	public EList<PClabject> getParticipants() {
		if (participants == null) {
			participants = new EObjectResolvingEList<PClabject>(PClabject.class, this, PanLevelModelPackage.PCONNECTOR__PARTICIPANTS);
		}
		return participants;
	}
	...
	public EList<String> getRoleNames() {
		if (roleNames == null) {
			roleNames = new EDataTypeUniqueEList<String>(String.class, this, PanLevelModelPackage.PCONNECTOR__ROLE_NAMES);
		}
		return roleNames;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PanLevelModelPackage.PCONNECTOR__PARTICIPANTS:
				return getParticipants();
			case PanLevelModelPackage.PCONNECTOR__ROLE_NAMES:
				return getRoleNames();
		}
