 ...
 * <ul>
 *   <li>{@link uni_mannheim.informatik.swt.models.plm.PLM.impl.PClabjectImpl#getType <em>Type</em>}</li>
 *   <li>{@link uni_mannheim.informatik.swt.models.plm.PLM.impl.PClabjectImpl#getSuperType <em>Super Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PClabjectImpl extends PInstantiableElementImpl implements PClabject {
	...
	protected EClass eStaticClass() {
		return PLMPackage.Literals.PCLABJECT;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PLMPackage.PCLABJECT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(PClabject newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.PCLABJECT__TYPE, oldType, type));
	}
	...
	public EList<PClabject> getSuperType() {
		if (superType == null) {
			superType = new EObjectResolvingEList<PClabject>(PClabject.class, this, PLMPackage.PCLABJECT__SUPER_TYPE);
		}
		return superType;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PLMPackage.PCLABJECT__TYPE:
				if (resolve) return getType();
				return basicGetType();
			case PLMPackage.PCLABJECT__SUPER_TYPE:
				return getSuperType();
		}
