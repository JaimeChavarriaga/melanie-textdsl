 ...
 * $Id$
 */
package tut.models.requirements.requirements.impl;
...
import tut.models.requirements.requirements.Comment;
import tut.models.requirements.requirements.Priority;
import tut.models.requirements.requirements.Requirement;
import tut.models.requirements.requirements.RequirementsPackage;
import tut.models.requirements.requirements.Resolution;
import tut.models.requirements.requirements.State;
import tut.models.requirements.requirements.Type;
import tut.models.requirements.requirements.Version;
 ...
 * <ul>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getType <em>Type</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getCretated <em>Cretated</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getId <em>Id</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getState <em>State</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getResolution <em>Resolution</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getDependencies <em>Dependencies</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link tut.models.requirements.requirements.impl.RequirementImpl#getComments <em>Comments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequirementImpl extends EObjectImpl implements Requirement {
	...
	/**
	 * The default value of the '{@link #getCretated() <em>Cretated</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCretated()
	 * @generated
	 * @ordered
	 */
	protected static final String CRETATED_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getCretated() <em>Cretated</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCretated()
	 * @generated
	 * @ordered
	 */
	protected String cretated = CRETATED_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setCretated(String newCretated) {
		String oldCretated = cretated;
		cretated = newCretated;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__CRETATED, oldCretated, cretated));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RequirementsPackage.REQUIREMENT__AUTHOR:
				return getAuthor();
			case RequirementsPackage.REQUIREMENT__CRETATED:
				return getCretated();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case RequirementsPackage.REQUIREMENT__CRETATED:
				return CRETATED_EDEFAULT == null ? cretated != null : !CRETATED_EDEFAULT.equals(cretated);
			case RequirementsPackage.REQUIREMENT__ID:
