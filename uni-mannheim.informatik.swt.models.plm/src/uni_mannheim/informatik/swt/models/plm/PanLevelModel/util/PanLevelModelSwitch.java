 ...
 * @generated
 */
public class PanLevelModelSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PanLevelModelPackage.PELEMENT: {
				PElement pElement = (PElement)theEObject;
				T result = casePElement(pElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PanLevelModelPackage.PLEVEL_SPECIFIC_ELEMENT: {
			...
			case PanLevelModelPackage.PMODULE: {
			...
			case PanLevelModelPackage.PINSTANTIABLE_ELEMENT: {
			...
			case PanLevelModelPackage.PPACKAGE: {
			...
			case PanLevelModelPackage.PCONNECTOR: {
			...
			case PanLevelModelPackage.PFIELD: {
			...
			case PanLevelModelPackage.PCLABJECT: {
			...
			case PanLevelModelPackage.PMETHOD: {
			...
			case PanLevelModelPackage.PNODE: {
			...
			case PanLevelModelPackage.PRELATIONSHIP: {
			...
			case PanLevelModelPackage.PGENERALIZATION: {
			...
			case PanLevelModelPackage.PINSTANTIATION: {
			...
			case PanLevelModelPackage.PAN_LEVEL_MODEL: {
