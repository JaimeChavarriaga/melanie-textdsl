 ...
 * @generated
 */
public class DomainEntityLabelExpressionLabelParser implements IParser {
	/**
	 * @generated
	 */
	public DomainEntityLabelExpressionLabelParser() {
	}
	...
	public String getPrintString(IAdaptable element, int flags) {
		...
		Object result = de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.expressions.PLMOCLFactory
				.getExpression(
						1,
						de.uni_mannheim.informatik.swt.models.plm.PLM.PLMPackage.eINSTANCE
								.getDomainEntity(), null).evaluate(target);
