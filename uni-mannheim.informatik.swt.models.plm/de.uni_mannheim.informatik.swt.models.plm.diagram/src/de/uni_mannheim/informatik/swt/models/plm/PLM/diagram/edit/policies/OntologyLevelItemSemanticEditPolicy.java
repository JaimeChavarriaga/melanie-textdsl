 ...
 * @generated
 */
public class OntologyLevelItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public OntologyLevelItemSemanticEditPolicy() {
		super(
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.providers.PLMElementTypes.DomainEntity_3002 == req
				.getElementType()) {
			return getGEFWrapper(new de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.commands.DomainEntityCreateCommand(
					req));
		}
		if (de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.providers.PLMElementTypes.DomainConnection_3003 == req
				.getElementType()) {
			...
			case de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainEntityEditPart.VISUAL_ID:
				for (Iterator<?> it = node.getTargetEdges().iterator(); it
					...
					if (de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.part.PLMVisualIDRegistry
							.getVisualID(incomingLink) == de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainConnection2EditPart.VISUAL_ID) {
