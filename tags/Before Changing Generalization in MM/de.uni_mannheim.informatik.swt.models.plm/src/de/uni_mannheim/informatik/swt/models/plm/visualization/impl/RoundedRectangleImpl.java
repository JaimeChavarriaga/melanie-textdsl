 ...
 * <ul>
 *   <li>{@link de.uni_mannheim.informatik.swt.models.plm.visualization.impl.RoundedRectangleImpl#getRadius <em>Radius</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoundedRectangleImpl extends RectangleImpl implements RoundedRectangle {
	...
	protected EClass eStaticClass() {
		return VisualizationPackage.Literals.ROUNDED_RECTANGLE;
	}
	...
	public void setRadius(int newRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualizationPackage.ROUNDED_RECTANGLE__RADIUS, oldRadius, radius));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisualizationPackage.ROUNDED_RECTANGLE__RADIUS:
				return getRadius();
		}
