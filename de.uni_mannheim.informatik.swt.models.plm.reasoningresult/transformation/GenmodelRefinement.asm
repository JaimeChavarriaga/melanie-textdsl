...
<asm version="1.0" name="0">
	<cp>
		<constant value="GenmodelRefinement"/>
		...
		<constant value="A.__matchRefineGenPackage():V"/>
		<constant value="A.__matchRefineGenModel():V"/>
		<constant value="__exec__"/>
		<constant value="RefineGenPackage"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyRefineGenPackage(NTransientLink;):V"/>
		<constant value="RefineGenModel"/>
		<constant value="A.__applyRefineGenModel(NTransientLink;):V"/>
		...
		<constant value="__matchRefineGenPackage"/>
		<constant value="GenPackage"/>
		<constant value="genmodel"/>
		<constant value="IN"/>
		...
		<constant value="__applyRefineGenPackage"/>
		<constant value="NTransientLink;"/>
		<constant value="NTransientLink;.getSourceElement(S):J"/>
		<constant value="NTransientLink;.getTargetElement(S):J"/>
		<constant value="basePackage"/>
		<constant value="de.uni_mannheim.informatik.swt.models.plm.reasoningresult"/>
		<constant value="MRefiningTrace!Element;.setProperty(SJB):V"/>
		<constant value="29:19-29:78"/>
		<constant value="29:4-29:78"/>
		<constant value="link"/>
		<constant value="__matchRefineGenModel"/>
		<constant value="GenModel"/>
		<constant value="38:3-40:4"/>
		<constant value="__applyRefineGenModel"/>
		<constant value="operationReflection"/>
		<constant value="39:27-39:31"/>
	...
	<operation name="113">
		...
		<linenumbertable>
			<lne id="124" begin="19" end="33"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="1" name="119" begin="6" end="35"/>
	...
	<operation name="125">
		...
		<linenumbertable>
			...
			<lne id="133" begin="9" end="15"/>
			<lne id="124" begin="8" end="16"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="121" begin="7" end="16"/>
			<lve slot="2" name="119" begin="3" end="16"/>
			<lve slot="0" name="26" begin="0" end="16"/>
			<lve slot="1" name="134" begin="0" end="16"/>
		</localvariabletable>
	</operation>
	<operation name="135">
		<context type="7"/>
