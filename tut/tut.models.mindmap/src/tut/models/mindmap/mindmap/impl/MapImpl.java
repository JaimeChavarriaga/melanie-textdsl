 ...
 * <ul>
 *   <li>{@link tut.models.mindmap.mindmap.impl.MapImpl#getName <em>Name</em>}</li>
 *   <li>{@link tut.models.mindmap.mindmap.impl.MapImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link tut.models.mindmap.mindmap.impl.MapImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link tut.models.mindmap.mindmap.impl.MapImpl#getRootTopics <em>Root Topics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MapImpl extends EObjectImpl implements Map {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindmapPackage.MAP__NAME, oldName, name));
	}
