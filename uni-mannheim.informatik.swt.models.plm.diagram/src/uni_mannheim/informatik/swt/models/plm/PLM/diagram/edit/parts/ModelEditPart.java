...
public class ModelEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.policies.ModelItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.policies.ModelCanonicalEditPolicy());
