...
public class DomainConnectionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainConnectionNameLevelEditPart) {
			((de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.parts.DomainConnectionNameLevelEditPart) childEditPart)
	 ...
	 * @generated
	 */
	public class DomainConnectionFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			this.add(fFigureDomainConnectionNameFigure);
