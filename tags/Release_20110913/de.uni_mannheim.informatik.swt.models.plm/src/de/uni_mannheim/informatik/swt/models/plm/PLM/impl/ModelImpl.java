...
public class ModelImpl extends ElementImpl implements Model {
	...
	/**
	 * The cached invocation delegate for the '{@link #getAllInstantiations() <em>Get All Instantiations</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAllInstantiations()
	 * @generated
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_ALL_INSTANTIATIONS__EINVOCATION_DELEGATE = ((EOperation.Internal)PLMPackage.Literals.MODEL___GET_ALL_INSTANTIATIONS).getInvocationDelegate();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public EList<Instantiation> getAllInstantiations() {
		try {
			return (EList<Instantiation>)GET_ALL_INSTANTIATIONS__EINVOCATION_DELEGATE.dynamicInvoke(this, null);
		}
		catch (InvocationTargetException ite) {
			throw new WrappedException(ite);
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case PLMPackage.MODEL___GET_ALL_INSTANTIATIONS:
