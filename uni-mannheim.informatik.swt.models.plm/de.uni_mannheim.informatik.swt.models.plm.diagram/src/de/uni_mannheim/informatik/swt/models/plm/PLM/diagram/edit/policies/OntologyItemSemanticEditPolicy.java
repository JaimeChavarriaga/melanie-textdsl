 ...
 * @generated
 */
public class OntologyItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public OntologyItemSemanticEditPolicy() {
		super(
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.providers.PLMElementTypes.OntologyLevel_3001 == req
				.getElementType()) {
			return getGEFWrapper(new de.uni_mannheim.informatik.swt.models.plm.PLM.diagram.edit.commands.OntologyLevelCreateCommand(
					req));
		}
