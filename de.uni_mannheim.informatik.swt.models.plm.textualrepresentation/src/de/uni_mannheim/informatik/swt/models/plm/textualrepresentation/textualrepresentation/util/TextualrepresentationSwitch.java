...
public class TextualrepresentationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TextualrepresentationPackage.TEXTUAL_DSL_VISUALIZER: {
				...
				if (result == null) result = caseAbstractVisualizer(textualDSLVisualizer);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Visualizer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Visualizer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractVisualizer(AbstractVisualizer object) {
		return null;
	}
